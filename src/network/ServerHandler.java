...
import network.packs.CommandExecPack;
            ...
            if (obj instanceof String)
                ...
                try {
                    ...
                    if(retObj instanceof Credentials){
                        responseExecution = new CommandExecPack(retObj);
                    }else if(retObj != null){
                        responseExecution = new CommandExecPack(retObj);
                    }else {
                        responseExecution = new CommandExecPack(new String(outputStream.toByteArray()));
                    }
