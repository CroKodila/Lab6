...
public class SqlQuery {
    public static class Get {
        //City
        public static final String ORGANIZATION = "SELECT organization.id, organization.name, coordinates.x, coordinates.y, organization.creation_date, organization.annual_turnover, organization.full_name, organization.employees_count, organization.type, organization.street, organization.zip_code\n" +
                "FROM organization\n" +
    ...
    public static class Add {
        ...
        public static final String ORGANIZATION = "" +
                "INSERT INTO organization (name, creation_date, annual_turnover, full_name, employees_count, type, street, zip_code)\n"+
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?) RETURNING id";
    ...
    public static class Update {
        public static final String ORGANIZATION = "" +
        "UPDATE organization SET name=?, creation_date=?, annual_turnover=?, full_name=?, employees_count=?, type=?, street=?, zip_code=?\n"+
